    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-md glass-panel p-8 rounded-2xl">
                ...
                <p className="text-gray-400 text-sm text-center mb-8">Start creating with UGC AI today</p>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <PrimaryButton disabled={loading} className="w-full py-3 rounded-xl mt-2">
